...
// acreage filter doesnot work but shape filter and downlaod does work fine
// App.jsx
...
function App() {
  ...
  // State for filtered shape data used only for download
  ...
  const downloadFilteredDataToExcel = () => {
    // Use shapeFilteredData for filtering pricing points
